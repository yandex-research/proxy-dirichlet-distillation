        ...
        for i, sample_id in enumerate(sample["id"].tolist()):
            ...
            for j, hypo in enumerate(hypos[i][: cfg.generation.nbest]):
                ...
                if not cfg.common_eval.quiet:
                    ...
                    if cfg.generation.compute_uncertainty:
                        print('T-EOE-{}\t{}'.format(
                            sample_id,
                            ' '.join(map(
                        ...
                        print(
                            'SU-{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}'.format(
                                sample_id,
                                hypo['sequence_uncertainties']['pe_entropy_of_expected'].double().cpu(),
                                hypo['sequence_uncertainties']['expected_entropy'].double().cpu(),
                                hypo['sequence_uncertainties']['pe_mutual_information'].double().cpu(),
                                hypo['sequence_uncertainties']['pe_EPKL'].double().cpu(),
                                hypo['sequence_uncertainties']['pe_sTU'].double().cpu(),
                                hypo['sequence_uncertainties']['ep_sTU'].double().cpu(),
                                hypo['sequence_uncertainties']['sDU'].double().cpu(),
                                hypo['sequence_uncertainties']['ep_sMKL'].double().cpu(),
                                hypo['sequence_uncertainties']['pe_sMKL'].double().cpu(),
                                hypo['sequence_uncertainties']['log-prob'],
                                hypo['sequence_uncertainties']['ep_entropy_of_expected'].double().cpu(),
                                hypo['sequence_uncertainties']['ep_mutual_information'].double().cpu(),
                                hypo['sequence_uncertainties']['ep_EPKL'].double().cpu(),
                                hypo['sequence_uncertainties']['ep_MKL'].double().cpu(),
                                hypo['sequence_uncertainties']['pe_MKL'].double().cpu(),
                                hypo['sequence_uncertainties']['var'].double().cpu(),
                                hypo['sequence_uncertainties']['combo'].double().cpu(),
                                hypo['sequence_uncertainties']['logvar'].double().cpu(),
                                hypo['sequence_uncertainties']['logcombo'].double().cpu(),
                            ))

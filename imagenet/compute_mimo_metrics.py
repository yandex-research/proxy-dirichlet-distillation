...
from evaluation import get_domain_uncertainties, mimo_predictions
...
def main(args):
    ...
    model = ImagenetMIMOClassifier.load_from_checkpoint(args.resume_from_checkpoint, learning_rate=0.1,
                                                        weight_decay=1e-4, epochs=90).to_torchscript()
    ...
    prediction_func = partial(mimo_predictions, model=model)
